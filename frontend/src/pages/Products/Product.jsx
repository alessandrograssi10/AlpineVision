...
export const Product = () => {
    ...
    return (
            ...
            <Row className="d-flex align-items-center pl-3 pt-3 equal-height">
                ...
                <Col lg={5}  className="white-panel  p-0 justify-content-center carosello-prod">
                    <div className="shadow-box mx-0">
                        <Row>
                            <h2 className="text-left text-black">{productInfo.nome}</h2>
                        </Row>
                        <Row>
      ...
      //justify
    >
      <Tab eventKey="vetrina" title="Vetrina" className='dark p-0 color-black dark-prod'>
      
      <Row className="m-0 p-0 w-100 h-100 no-space-rowBg-prod">
            <Image src={ImgSimpatica} className="p-0 img-fluid-no-space w-100 darkness" />
    ...
    <Row className="m-0 p-0 w-100 h-100 no-space-rowBg-prod">
            <Image src={ImgInnovativa} className="p-0 img-fluid-no-space w-100" />
          </Row>
      </Tab>
